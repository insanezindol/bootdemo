...
public class RabbitMQConfig {
    ...
    private static final String topicExchangeName = "zindol-exchange";

    private static final String queueName = "zindol-queue";
    ...
    Binding binding(Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("com.zindol.#");
    }
